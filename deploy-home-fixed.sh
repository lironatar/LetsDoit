...
# ToDoFast Deployment in Home Directory - Fixed Version
# Repository: https://github.com/lironatar/LetsDoit.git
# Using /home/todofast/ for better permissions
# This version runs system commands as root, app setup as user
...
echo "=== ToDoFast Deployment in Home Directory (Fixed) ==="
...
log_step "Starting deployment in home directory..."

# 1. Create application user (as root)
log_step "1. Creating application user..."
if id "$APP_USER" &>/dev/null; then
    log_info "User $APP_USER already exists"
else
    useradd --system --group --shell /bin/bash --home-dir $HOME_DIR --create-home $APP_USER
    log_info "Created user: $APP_USER with home directory: $HOME_DIR"
fi
...
# 4. Setup frontend (as user - this should work much better in home directory)
...
echo ""
log_info "Deployment completed successfully in home directory!"
