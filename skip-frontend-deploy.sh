...
# Deploy ToDoFast without frontend build
# This script deploys Django backend only, frontend can be built later
...
log_step "Deploying ToDoFast Django backend (skipping frontend for now)..."
...
echo "  4. Build frontend later when npm issues are resolved"
echo ""
